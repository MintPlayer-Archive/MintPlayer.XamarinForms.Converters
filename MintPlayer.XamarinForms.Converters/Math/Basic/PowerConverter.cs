...
{
    /// <summary>Binding converter that outputs the power of the first element by the second element.</summary>
    public class PowerConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return System.Math.Pow(doubles[0], doubles[1]);
        }
        ...
        {
            throw new NotImplementedException($"The {nameof(PowerConverter)} can only be used with Mode=OneWay");
        }
    }
}
