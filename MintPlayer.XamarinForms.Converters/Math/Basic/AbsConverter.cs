...
{
    /// <summary>Binding converter that outputs the absolute value of its input.</summary>
    public class AbsConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(AbsConverter)} must be a double", ex);
            }
        }
