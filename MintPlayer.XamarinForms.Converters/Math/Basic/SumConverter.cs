...
{
    /// <summary>Binding converter that outputs the sum of the inputs.</summary>
    public class SumConverter : IMultiValueConverter
    {
        ...
        {
            throw new NotImplementedException($"The {nameof(SumConverter)} can only be used with Mode=OneWay");
        }
    }
}
