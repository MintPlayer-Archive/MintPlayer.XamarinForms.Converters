...
{
    /// <summary>Binding converter that outputs the opposite (-) of the input.</summary>
    public class MinusConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(MinusConverter)} must be a double", ex);
            }
        }
