...
{
    /// <summary>Binding converter that outputs the division of the first element by the second element.</summary>
    public class DivideByConverter : IMultiValueConverter
    {
        ...
        {
            throw new NotImplementedException($"The {nameof(DivideByConverter)} can only be used with Mode=OneWay");
        }
    }
}
