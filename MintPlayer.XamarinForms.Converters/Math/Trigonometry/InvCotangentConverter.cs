...
{
    /// <summary>Binding converter that outputs the angle whose cotangent (1 / tan(x)) equals the input.</summary>
    public class InvCotangentConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(InvCotangentConverter)} must be a double", ex);
            }
        }
