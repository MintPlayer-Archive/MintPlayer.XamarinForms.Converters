...
{
    /// <summary>Binding converter that outputs the cosecant (1 / sin(x)) of the input.</summary>
    public class CosecantConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(CosecantConverter)} must be a double", ex);
            }
        }
