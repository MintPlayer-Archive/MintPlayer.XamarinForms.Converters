...
{
    /// <summary>Binding converter that outputs the hyperbolic sine of the input.</summary>
    public class SineHConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(SineHConverter)} must be a double", ex);
            }
        }
