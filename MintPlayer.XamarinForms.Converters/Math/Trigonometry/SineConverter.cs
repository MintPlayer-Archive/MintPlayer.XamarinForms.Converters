...
{
    /// <summary>Binding converter that outputs the sine of the input.</summary>
    public class SineConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(SineConverter)} must be a double", ex);
            }
        }
