...
{
    /// <summary>Binding converter that outputs the angle whose sine equals the input.</summary>
    public class InvSineConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(InvSineConverter)} must be a double", ex);
            }
        }
