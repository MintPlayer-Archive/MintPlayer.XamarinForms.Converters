...
{
    /// <summary>Binding converter that outputs the angle whose hyperbolic cotangent (1 / tanh(x)) equals the input.</summary>
    public class InvCotangentHConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(InvCotangentHConverter)} must be a double", ex);
            }
        }
