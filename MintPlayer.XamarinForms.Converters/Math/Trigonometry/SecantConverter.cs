...
{
    /// <summary>Binding converter that outputs the secant (1 / cos(x)) of the input.</summary>
    public class SecantConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(SecantConverter)} must be a double", ex);
            }
        }
