...
{
    /// <summary>Binding converter that outputs the angle whose tangent equals the input.</summary>
    public class InvTangentConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(InvTangentConverter)} must be a double", ex);
            }
        }
