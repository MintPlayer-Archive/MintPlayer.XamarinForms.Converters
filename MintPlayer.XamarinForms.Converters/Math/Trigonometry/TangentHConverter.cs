...
{
    /// <summary>Binding converter that outputs the hyperbolic tangent of the input.</summary>
    public class TangentHConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(TangentHConverter)} must be a double", ex);
            }
        }
