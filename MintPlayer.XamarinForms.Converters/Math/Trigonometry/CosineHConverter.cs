...
{
    /// <summary>Binding converter that outputs the hyperbolic cosine of the input.</summary>
    public class CosineHConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(CosineHConverter)} must be a double", ex);
            }
        }
