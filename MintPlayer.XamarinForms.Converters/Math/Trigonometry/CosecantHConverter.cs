...
{
    /// <summary>Binding converter that outputs the hyperbolic cosecant (1 / sinh(x)) of the input.</summary>
    public class CosecantHConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(CosecantHConverter)} must be a double", ex);
            }
        }
