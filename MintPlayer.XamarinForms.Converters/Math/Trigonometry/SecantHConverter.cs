...
{
    /// <summary>Binding converter that outputs the hyperbolic secant (1 / cosh(x)) of the input.</summary>
    public class SecantHConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                throw new ArgumentException($"Value provided to the {nameof(SecantHConverter)} must be a double", ex);
            }
        }
